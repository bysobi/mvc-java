...
<title><fmt:message key="edit_test.title" /></title>
...
<body>
	...
	<div id="wraper">
		...
		<div id="content">
			<h3>
				<fmt:message key="edit_test.h3" />
			</h3>

			<form action="controller?command=doEditTest" method="post">
				<input type="hidden" name="id" value="${id}" />
				<table>
					<tr>
						<td><fmt:message key="edit_test.name" /></td>
					...
					<tr>
						<td><fmt:message key="edit_test.subjectName" /></td>
					...
					<tr>
						<td><fmt:message key="edit_test.timeToPass" /></td>
					...
					<tr>
						...
						<td><input type="submit"
							value="<fmt:message key="edit_test.saveChanges"/>" /></td>
					</tr>
				</table>
			</form>
			<p>
				<a href="controller?command=removeTest&id=${id}"><fmt:message
						key="edit_test.removeTest" /></a>
			</p>
		</div>
	</div>
